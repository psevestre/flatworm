...
public class CoreConverters
{
    ...
    public Date convertDate(String str, Map<String, ConversionOption> options) throws FlatwormConversionException
    {
        try
        {
    ...
    public Double convertDecimal(String str, Map<String, ConversionOption> options) throws FlatwormConversionException
    {
        try
        {
            int decimalPlaces = 0;
